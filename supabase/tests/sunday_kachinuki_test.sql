...
from unnest(array[1,2,3,4,5,6,7,99]) number;
...
select is((select count(*) from sunday_private.profile_sessions),7::bigint,'seven phone sessions link to six profiles');
